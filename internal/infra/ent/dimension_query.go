...
func (_q *DimensionQuery) QueryModule() *ModuleQuery {
...
func (_q *DimensionQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *DimensionQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *DimensionQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *DimensionQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *DimensionQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *DimensionQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *DimensionQuery) WithModule(opts ...func(*ModuleQuery)) *DimensionQuery {
	query := (&ModuleClient{config: _q.config}).Query()
...
//		GroupBy(dimension.FieldModuleID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Dimension.Query().
//		Select(dimension.FieldModuleID).
//		Scan(ctx, &v)
...
func (_q *DimensionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Dimension, error) {
	...
	if query := _q.withModule; query != nil {
		if err := _q.loadModule(ctx, query, nodes, nil,
			func(n *Dimension, e *Module) { n.Edges.Module = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DimensionQuery) loadModule(ctx context.Context, query *ModuleQuery, nodes []*Dimension, init func(*Dimension), assign func(*Dimension, *Module)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Dimension)
	for i := range nodes {
		fk := nodes[i].ModuleID
...
func (_q *DimensionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(dimension.Table, dimension.Columns, sqlgraph.NewFieldSpec(dimension.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withModule != nil {
			_spec.Node.AddColumnOnce(dimension.FieldModuleID)
		}
	}
