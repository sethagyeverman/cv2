...
// The AIRecordFunc type is an adapter to allow the use of ordinary
// function as AIRecord mutator.
type AIRecordFunc func(context.Context, *ent.AIRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AIRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AIRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AIRecordMutation", m)
}
...
// The ResumeScoreFunc type is an adapter to allow the use of ordinary
// function as ResumeScore mutator.
type ResumeScoreFunc func(context.Context, *ent.ResumeScoreMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ResumeScoreFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ResumeScoreMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ResumeScoreMutation", m)
}

// The ResumeSlotFunc type is an adapter to allow the use of ordinary
// function as ResumeSlot mutator.
type ResumeSlotFunc func(context.Context, *ent.ResumeSlotMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ResumeSlotFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ResumeSlotMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ResumeSlotMutation", m)
}
