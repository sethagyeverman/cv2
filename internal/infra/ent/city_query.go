...
func (_q *CityQuery) QueryChildren() *CityQuery {
...
func (_q *CityQuery) QueryParent() *CityQuery {
	query := (&CityClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *CityQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CityQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *CityQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CityQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *CityQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *CityQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CityQuery) WithChildren(opts ...func(*CityQuery)) *CityQuery {
	query := (&CityClient{config: _q.config}).Query()
...
func (_q *CityQuery) WithParent(opts ...func(*CityQuery)) *CityQuery {
	query := (&CityClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CityQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*City, error) {
	...
	if query := _q.withChildren; query != nil {
		if err := _q.loadChildren(ctx, query, nodes,
			func(n *City) { n.Edges.Children = []*City{} },
			func(n *City, e *City) { n.Edges.Children = append(n.Edges.Children, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withParent; query != nil {
		if err := _q.loadParent(ctx, query, nodes, nil,
			func(n *City, e *City) { n.Edges.Parent = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *CityQuery) loadChildren(ctx context.Context, query *CityQuery, nodes []*City, init func(*City), assign func(*City, *City)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*City)
	for i := range nodes {
...
func (_q *CityQuery) loadParent(ctx context.Context, query *CityQuery, nodes []*City, init func(*City), assign func(*City, *City)) error {
...
func (_q *CityQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(city.Table, city.Columns, sqlgraph.NewFieldSpec(city.FieldID, field.TypeInt64))
	_spec.From = _q.sql
