...
func HasDimensionsWith(preds ...predicate.Dimension) predicate.Module {
	return predicate.Module(func(s *sql.Selector) {
		step := newDimensionsStep()
